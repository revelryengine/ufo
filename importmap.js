...
element.textContent = JSON.stringify({
    imports: {
        ...
        'revelryengine/core/'     : 'https://cdn.jsdelivr.net/gh/revelryengine/core@v0.2.1-alpha/',
        'revelryengine/gltf/'     : 'https://cdn.jsdelivr.net/gh/revelryengine/gltf@v0.2.1-alpha/',
        'revelryengine/renderer/' : 'https://cdn.jsdelivr.net/gh/revelryengine/renderer@v0.2.1-alpha/',
